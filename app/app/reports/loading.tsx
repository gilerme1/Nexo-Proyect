  ...
  return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="flex gap-3 flex-wrap">
        <div className="h-9 w-72 rounded-full bg-[var(--bg-card)]" />
        <div className="h-9 flex-1 min-w-[180px] rounded-full bg-[var(--bg-card)]" />
      </div>
          ...
          <div key={i} className="flex items-center gap-4 px-3 py-3.5">
            ...
            <div className="flex-1 space-y-1.5">
              <div className="flex items-center gap-2">
                <div className="h-3.5 w-20 rounded bg-[var(--bg-hover)]" />
                <div className="h-5 w-20 rounded-full bg-[var(--bg-hover)]" />
              </div>
              <div className="h-3 w-48 rounded bg-[var(--bg-hover)]" />
            </div>
            <div className="h-7 w-7 rounded-full bg-[var(--bg-hover)]" />
          </div>
        ))}
      </div>
    </div>
